...
class webserverjpg(threading.Thread):
    ...
    class StreamingOutput(io.BufferedIOBase):
        def __init__(self):
            ...
            self.clear_interval = 0  # Set the clear interval to N seconds
...
if __name__ == '__main__':
    ...
    wserver = webserverjpg(host="192.168.0.41", port=8080)
    wserver.start()
    current_path = os.path.dirname(os.path.abspath(__file__))
    ROOT = os.path.dirname(current_path)
    logo_path = os.path.join(ROOT, "/awmcam/camsimul", "logo.jpg")
    logo_path = "/home/pi/awmcam/camsimul/logo.jpg"
    print(logo_path)
