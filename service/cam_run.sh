...
#mjpg_streamer -i '/usr/local/lib/mjpg-streamer/input_file.so -e -f /home/pi/awmcam/camsimul' -o '/usr/local/lib/mjpg-streamer/output_http.so -w /home/pi/mjpg-streamer/mjpg-streamer-experimental/www -p 8080'
